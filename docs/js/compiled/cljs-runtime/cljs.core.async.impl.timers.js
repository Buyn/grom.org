...
var i_16157 = (self__.level + (1));
while(true){
if((i_16157 <= (new_level + (1)))){
(update[i_16157] = self__.header);

var G__16158 = (i_16157 + (1));
i_16157 = G__16158;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_16160 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_16160[i]));
} else {
x__$2.forward.push((((i < links_16160.length))?(links_16160[i]):null));
}

if((i < links_16160.length)){
(links_16160[i] = x__$2);
} else {
links_16160.push(x__$2);
}
...
if((x__$1 === (((i_16180 < links_16181.length))?(links_16181[i_16180]):null))){
(links_16181[i_16180] = (x__$1.forward[i_16180]));

var G__16186 = (i_16180 + (1));
i_16180 = G__16186;
continue;
} else {
var G__16191 = (i_16180 + (1));
i_16180 = G__16191;
continue;
}
} else {
...
var G__16207 = nx;
var G__16208 = (level__$1 - (1));
x = G__16207;
level__$1 = G__16208;
continue;
} else {
var G__16210 = x;
var G__16211 = (level__$1 - (1));
x = G__16210;
level__$1 = G__16211;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__16215 = nx;
var G__16216 = (level__$1 - (1));
x = G__16215;
level__$1 = G__16216;
continue;
} else {
var G__16218 = x;
var G__16219 = (level__$1 - (1));
x = G__16218;
level__$1 = G__16219;
continue;
}
