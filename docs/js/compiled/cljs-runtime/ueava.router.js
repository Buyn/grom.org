...
ueava.router.routes = new cljs.core.PersistentArrayMap(null, 3, ["/",new cljs.core.Keyword(null,"home","home",-74557309),"/about",new cljs.core.Keyword(null,"about","about",1423892543),"/membership",new cljs.core.Keyword(null,"membership","membership",254556333)], null);
ueava.router.current_route = (function ueava$router$current_route(){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(ueava.router.routes,location.pathname,new cljs.core.Keyword(null,"home","home",-74557309));
});
...
return window.addEventListener("popstate",ueava.router.sync_route_BANG_);
});
ueava.router.navigate_BANG_ = (function ueava$router$navigate_BANG_(url){
history.pushState(null,"",url);

return ueava.router.sync_route_BANG_();
});
