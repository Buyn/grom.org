...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15455 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15455(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_15463 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_15463(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_15468 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_15468(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_15472 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_15472(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15483 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15483(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15488 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15488(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__15440,callback){
var map__15441 = p__15440;
var map__15441__$1 = cljs.core.__destructure_map(map__15441);
var input = map__15441__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15441__$1,new cljs.core.Keyword(null,"code","code",1586293142));
