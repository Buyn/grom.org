...
var G__19309 = o;
(G__19309[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__19805__delegate = function (args){
...
while (G__19806__i < G__19806__a.length) {G__19806__a[G__19806__i] = arguments[G__19806__i + 0]; ++G__19806__i;}
  args = new cljs.core.IndexedSeq(G__19806__a,0,null);
} 
return G__19805__delegate.call(this,args);};
...
return G__19805__delegate(args);
});
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__19350){
var map__19351 = p__19350;
var map__19351__$1 = cljs.core.__destructure_map(map__19351);
var props = map__19351__$1;
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__19403){
var map__19405 = p__19403;
var map__19405__$1 = cljs.core.__destructure_map(map__19405);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19405__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__19454){
var map__19456 = p__19454;
var map__19456__$1 = cljs.core.__destructure_map(map__19456);
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19456__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19456__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__19464 = jsprops;
(G__19464["defaultValue"] = value);

(G__19464["onChange"] = (function (p1__19437_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__19437_SHARP_);
}));
...
var vec__19520 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19520,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19520,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19520,(2),null);
...
var jsprops = ({"argv": v});
var temp__5808__auto___19853 = reagent.impl.template.key_from_vec(v);
if((temp__5808__auto___19853 == null)){
} else {
var key_19854 = temp__5808__auto___19853;
(jsprops["key"] = key_19854);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__19556){
var map__19558 = p__19556;
var map__19558__$1 = cljs.core.__destructure_map(map__19558);
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19558__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__19564 = reagent.impl.template.__GT_NativeWrapper();
(G__19564["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__19571 = wrapped;
(G__19571["syntheticInput"] = true);

return G__19571;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__19574 = wrapped__$1;
(G__19574["syntheticOnChange"] = on_change);

return G__19574;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__19576 = wrapped__$2;
(G__19576["syntheticOnUpdate"] = on_update);
...
var G__19870 = (i__5727__auto___19868 + (1));
i__5727__auto___19868 = G__19870;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq19628){
var G__19629 = cljs.core.first(seq19628);
var seq19628__$1 = cljs.core.next(seq19628);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19629,seq19628__$1);
}));
...
break;
default:
var G__19882 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__19882;
continue;
...
var n__5593__auto___19883 = a.length;
var i_19884 = (0);
while(true){
if((i_19884 < n__5593__auto___19883)){
(a[i_19884] = reagent.impl.template.as_element((a[i_19884])));

var G__19888 = (i_19884 + (1));
i_19884 = G__19888;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5593__auto___19889 = a.length;
var i_19890 = (0);
while(true){
if((i_19890 < n__5593__auto___19889)){
var val_19891 = (a[i_19890]);
if(((cljs.core.vector_QMARK_(val_19891)) && ((reagent.impl.template.key_from_vec(val_19891) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_19890] = reagent.impl.template.as_element(val_19891));
...
var ctx = ({});
var vec__19721 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19721,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19721,(1),null);
...
var G__19769 = (cljs.core.count(argv) - first_child);
switch (G__19769) {
case (0):
