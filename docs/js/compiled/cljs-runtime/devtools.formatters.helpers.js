...
var G__15645 = devtools.prefs.pref(v);
v = G__15645;
continue;
} else {
return v;
...
}catch (e15474){var _e__11889__auto__ = e15474;
return false;
}})();
...
}catch (e15481){var _e__11889__auto__ = e15481;
return false;
}})();
...
}catch (e15485){var _e__11889__auto__ = e15485;
return false;
}}
}
});
...
var vec__15526 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15526,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15526,(1),null);
...
return cljs.core.some((function (p1__15551_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15551_SHARP_);
}),template);
});
