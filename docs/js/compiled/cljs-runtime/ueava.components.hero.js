...
var map__14608 = cljs.core.deref(ueava.components.hero.state);
var map__14608__$1 = cljs.core.__destructure_map(map__14608);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14608__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14608__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var last_ts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14608__$1,new cljs.core.Keyword(null,"last-ts","last-ts",-1610675580));
...
var map__14609_14616 = cljs.core.deref(ueava.components.hero.state);
var map__14609_14617__$1 = cljs.core.__destructure_map(map__14609_14616);
var current_14618 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14609_14617__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim_14619 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14609_14617__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(anim_14619,new cljs.core.Keyword(null,"idle","idle",-2007156861))){
ueava.components.hero.go_BANG_(ueava.components.hero.next_random(current_14618),new cljs.core.Keyword(null,"right","right",-452581833));
} else {
}
...
var map__14610 = cljs.core.deref(ueava.components.hero.state);
var map__14610__$1 = cljs.core.__destructure_map(map__14610);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14610__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var prev = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14610__$1,new cljs.core.Keyword(null,"prev","prev",-1597069226));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14610__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14610__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14610__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
var map__14611 = cljs.core.deref(ueava.components.hero.state);
var map__14611__$1 = cljs.core.__destructure_map(map__14611);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14611__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var map__14612 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ueava.components.hero.slides(),current);
var map__14612__$1 = cljs.core.__destructure_map(map__14612);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14612__$1,new cljs.core.Keyword(null,"title","title",636505583));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14612__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var btn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14612__$1,new cljs.core.Keyword(null,"btn","btn",1978294651));
...
ueava.components.hero.nav_item = (function ueava$components$hero$nav_item(idx,p__14613){
var map__14614 = p__14613;
var map__14614__$1 = cljs.core.__destructure_map(map__14614);
var img = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14614__$1,new cljs.core.Keyword(null,"img","img",1442687358));
var map__14615 = cljs.core.deref(ueava.components.hero.state);
var map__14615__$1 = cljs.core.__destructure_map(map__14615);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14615__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
