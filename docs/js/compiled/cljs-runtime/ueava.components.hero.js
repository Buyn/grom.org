...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"chameleon","chameleon",-2096197987),new cljs.core.Keyword(null,"img","img",1442687358),"img/Hero_Slide_1_chameleon.jpg",new cljs.core.Keyword(null,"title","title",636505583),ueava.components.lang.t(new cljs.core.Keyword("hero","chameleon","hero/chameleon",-2059551065)),new cljs.core.Keyword(null,"text","text",-1790561697),"Specialized care for exotic animals.",new cljs.core.Keyword(null,"btn","btn",1978294651),"Become Member"], null),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"owl","owl",-23233972),new cljs.core.Keyword(null,"img","img",1442687358),"img/Hero_Slide_2_owl.jpg",new cljs.core.Keyword(null,"title","title",636505583),ueava.components.lang.t(new cljs.core.Keyword("hero","owl","hero/owl",-26326442)),new cljs.core.Keyword(null,"text","text",-1790561697),"Support for bird specialists worldwide.",new cljs.core.Keyword(null,"btn","btn",1978294651),"Learn More"], null),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"rabbit","rabbit",-447894503),new cljs.core.Keyword(null,"img","img",1442687358),"img/Hero_Slide_3_rabbit.jpg",new cljs.core.Keyword(null,"title","title",636505583),ueava.components.lang.t(new cljs.core.Keyword("hero","rabbit","hero/rabbit",-446768089)),new cljs.core.Keyword(null,"text","text",-1790561697),"Advanced treatment for rabbits and rodents.",new cljs.core.Keyword(null,"btn","btn",1978294651),"Join UEAVA"], null),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"bear","bear",-413943675),new cljs.core.Keyword(null,"img","img",1442687358),"img/Hero_Slide_4_bear.jpg",new cljs.core.Keyword(null,"title","title",636505583),ueava.components.lang.t(new cljs.core.Keyword("hero","bear","hero/bear",-412915589)),new cljs.core.Keyword(null,"text","text",-1790561697),"Supporting vets working with wildlife.",new cljs.core.Keyword(null,"btn","btn",1978294651),"Discover"], null)], null);
});
...
var map__12568 = cljs.core.deref(ueava.components.hero.state);
var map__12568__$1 = cljs.core.__destructure_map(map__12568);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12568__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12568__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var last_ts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12568__$1,new cljs.core.Keyword(null,"last-ts","last-ts",-1610675580));
...
var map__12569_12583 = cljs.core.deref(ueava.components.hero.state);
var map__12569_12584__$1 = cljs.core.__destructure_map(map__12569_12583);
var current_12585 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12569_12584__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim_12586 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12569_12584__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(anim_12586,new cljs.core.Keyword(null,"idle","idle",-2007156861))){
ueava.components.hero.go_BANG_(ueava.components.hero.next_random(current_12585),new cljs.core.Keyword(null,"right","right",-452581833));
} else {
}
...
var map__12576 = cljs.core.deref(ueava.components.hero.state);
var map__12576__$1 = cljs.core.__destructure_map(map__12576);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12576__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var prev = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12576__$1,new cljs.core.Keyword(null,"prev","prev",-1597069226));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12576__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12576__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12576__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
var map__12577 = cljs.core.deref(ueava.components.hero.state);
var map__12577__$1 = cljs.core.__destructure_map(map__12577);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12577__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var map__12578 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ueava.components.hero.slides(),current);
var map__12578__$1 = cljs.core.__destructure_map(map__12578);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12578__$1,new cljs.core.Keyword(null,"title","title",636505583));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12578__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var btn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12578__$1,new cljs.core.Keyword(null,"btn","btn",1978294651));
...
ueava.components.hero.nav_item = (function ueava$components$hero$nav_item(idx,p__12579){
var map__12580 = p__12579;
var map__12580__$1 = cljs.core.__destructure_map(map__12580);
var img = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12580__$1,new cljs.core.Keyword(null,"img","img",1442687358));
var map__12581 = cljs.core.deref(ueava.components.hero.state);
var map__12581__$1 = cljs.core.__destructure_map(map__12581);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12581__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
