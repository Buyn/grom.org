...
var map__13610 = cljs.core.deref(ueava.components.hero.state);
var map__13610__$1 = cljs.core.__destructure_map(map__13610);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13610__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13610__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var last_ts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13610__$1,new cljs.core.Keyword(null,"last-ts","last-ts",-1610675580));
...
var map__13612_13626 = cljs.core.deref(ueava.components.hero.state);
var map__13612_13627__$1 = cljs.core.__destructure_map(map__13612_13626);
var current_13628 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13612_13627__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim_13629 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13612_13627__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(anim_13629,new cljs.core.Keyword(null,"idle","idle",-2007156861))){
ueava.components.hero.go_BANG_(ueava.components.hero.next_random(current_13628),new cljs.core.Keyword(null,"right","right",-452581833));
} else {
}
...
var map__13619 = cljs.core.deref(ueava.components.hero.state);
var map__13619__$1 = cljs.core.__destructure_map(map__13619);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13619__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var prev = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13619__$1,new cljs.core.Keyword(null,"prev","prev",-1597069226));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13619__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13619__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13619__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
var map__13621 = cljs.core.deref(ueava.components.hero.state);
var map__13621__$1 = cljs.core.__destructure_map(map__13621);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13621__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var map__13622 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ueava.components.hero.slides(),current);
var map__13622__$1 = cljs.core.__destructure_map(map__13622);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13622__$1,new cljs.core.Keyword(null,"title","title",636505583));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13622__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var btn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13622__$1,new cljs.core.Keyword(null,"btn","btn",1978294651));
...
ueava.components.hero.nav_item = (function ueava$components$hero$nav_item(idx,p__13623){
var map__13624 = p__13623;
var map__13624__$1 = cljs.core.__destructure_map(map__13624);
var img = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13624__$1,new cljs.core.Keyword(null,"img","img",1442687358));
var map__13625 = cljs.core.deref(ueava.components.hero.state);
var map__13625__$1 = cljs.core.__destructure_map(map__13625);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13625__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
