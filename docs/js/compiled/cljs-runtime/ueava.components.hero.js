...
var map__12871 = cljs.core.deref(ueava.components.hero.state);
var map__12871__$1 = cljs.core.__destructure_map(map__12871);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12871__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12871__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var last_ts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12871__$1,new cljs.core.Keyword(null,"last-ts","last-ts",-1610675580));
...
var map__12872_12879 = cljs.core.deref(ueava.components.hero.state);
var map__12872_12880__$1 = cljs.core.__destructure_map(map__12872_12879);
var current_12881 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12872_12880__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim_12882 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12872_12880__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(anim_12882,new cljs.core.Keyword(null,"idle","idle",-2007156861))){
ueava.components.hero.go_BANG_(ueava.components.hero.next_random(current_12881),new cljs.core.Keyword(null,"right","right",-452581833));
} else {
}
...
var map__12873 = cljs.core.deref(ueava.components.hero.state);
var map__12873__$1 = cljs.core.__destructure_map(map__12873);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12873__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var prev = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12873__$1,new cljs.core.Keyword(null,"prev","prev",-1597069226));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12873__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12873__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12873__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
var map__12874 = cljs.core.deref(ueava.components.hero.state);
var map__12874__$1 = cljs.core.__destructure_map(map__12874);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12874__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var map__12875 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ueava.components.hero.slides(),current);
var map__12875__$1 = cljs.core.__destructure_map(map__12875);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12875__$1,new cljs.core.Keyword(null,"title","title",636505583));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12875__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var btn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12875__$1,new cljs.core.Keyword(null,"btn","btn",1978294651));
...
ueava.components.hero.nav_item = (function ueava$components$hero$nav_item(idx,p__12876){
var map__12877 = p__12876;
var map__12877__$1 = cljs.core.__destructure_map(map__12877);
var img = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12877__$1,new cljs.core.Keyword(null,"img","img",1442687358));
var map__12878 = cljs.core.deref(ueava.components.hero.state);
var map__12878__$1 = cljs.core.__destructure_map(map__12878);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12878__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
