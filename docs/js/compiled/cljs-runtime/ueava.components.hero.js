...
var map__12928 = cljs.core.deref(ueava.components.hero.state);
var map__12928__$1 = cljs.core.__destructure_map(map__12928);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12928__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12928__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var last_ts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12928__$1,new cljs.core.Keyword(null,"last-ts","last-ts",-1610675580));
...
var map__12941_12960 = cljs.core.deref(ueava.components.hero.state);
var map__12941_12961__$1 = cljs.core.__destructure_map(map__12941_12960);
var current_12962 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12941_12961__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim_12963 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12941_12961__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(anim_12963,new cljs.core.Keyword(null,"idle","idle",-2007156861))){
ueava.components.hero.go_BANG_(ueava.components.hero.next_random(current_12962),new cljs.core.Keyword(null,"right","right",-452581833));
} else {
}
...
var map__12948 = cljs.core.deref(ueava.components.hero.state);
var map__12948__$1 = cljs.core.__destructure_map(map__12948);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12948__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var prev = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12948__$1,new cljs.core.Keyword(null,"prev","prev",-1597069226));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12948__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12948__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12948__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
var map__12951 = cljs.core.deref(ueava.components.hero.state);
var map__12951__$1 = cljs.core.__destructure_map(map__12951);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12951__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var map__12952 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ueava.components.hero.slides(),current);
var map__12952__$1 = cljs.core.__destructure_map(map__12952);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12952__$1,new cljs.core.Keyword(null,"title","title",636505583));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12952__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var btn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12952__$1,new cljs.core.Keyword(null,"btn","btn",1978294651));
...
ueava.components.hero.nav_item = (function ueava$components$hero$nav_item(idx,p__12954){
var map__12955 = p__12954;
var map__12955__$1 = cljs.core.__destructure_map(map__12955);
var img = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12955__$1,new cljs.core.Keyword(null,"img","img",1442687358));
var map__12956 = cljs.core.deref(ueava.components.hero.state);
var map__12956__$1 = cljs.core.__destructure_map(map__12956);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12956__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
