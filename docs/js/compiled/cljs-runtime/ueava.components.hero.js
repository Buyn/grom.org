...
var map__12623 = cljs.core.deref(ueava.components.hero.state);
var map__12623__$1 = cljs.core.__destructure_map(map__12623);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12623__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12623__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var last_ts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12623__$1,new cljs.core.Keyword(null,"last-ts","last-ts",-1610675580));
...
var map__12624_12631 = cljs.core.deref(ueava.components.hero.state);
var map__12624_12632__$1 = cljs.core.__destructure_map(map__12624_12631);
var current_12633 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12624_12632__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var anim_12634 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12624_12632__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(anim_12634,new cljs.core.Keyword(null,"idle","idle",-2007156861))){
ueava.components.hero.go_BANG_(ueava.components.hero.next_random(current_12633),new cljs.core.Keyword(null,"right","right",-452581833));
} else {
}
...
var map__12625 = cljs.core.deref(ueava.components.hero.state);
var map__12625__$1 = cljs.core.__destructure_map(map__12625);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12625__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var prev = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12625__$1,new cljs.core.Keyword(null,"prev","prev",-1597069226));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12625__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
var anim = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12625__$1,new cljs.core.Keyword(null,"anim","anim",-1276068045));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12625__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
var map__12626 = cljs.core.deref(ueava.components.hero.state);
var map__12626__$1 = cljs.core.__destructure_map(map__12626);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12626__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var map__12627 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ueava.components.hero.slides,current);
var map__12627__$1 = cljs.core.__destructure_map(map__12627);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12627__$1,new cljs.core.Keyword(null,"title","title",636505583));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12627__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var btn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12627__$1,new cljs.core.Keyword(null,"btn","btn",1978294651));
...
ueava.components.hero.nav_item = (function ueava$components$hero$nav_item(idx,p__12628){
var map__12629 = p__12628;
var map__12629__$1 = cljs.core.__destructure_map(map__12629);
var img = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12629__$1,new cljs.core.Keyword(null,"img","img",1442687358));
var map__12630 = cljs.core.deref(ueava.components.hero.state);
var map__12630__$1 = cljs.core.__destructure_map(map__12630);
var current = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12630__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
