...
var o14380 = temp__5802__auto__;
var temp__5802__auto____$1 = (o14380["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o14381 = temp__5802__auto____$1;
return (o14381["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11873__auto__ = f;
return (o__11873__auto__["toString"]).call(o__11873__auto__);
} else {
return "";
}
}catch (e14386){var _ = e14386;
return "";
}});
...
try{var o__11873__auto___15203 = t;
(o__11873__auto___15203["cljs$lang$ctorPrWriter"]).call(o__11873__auto___15203,t,writer);
}catch (e14416){var __15204 = e14416;
}
...
var char_code = (function (){var o__11873__auto__ = (new String(char$));
return (o__11873__auto__["charCodeAt"]).call(o__11873__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11873__auto__ = String;
return (o__11873__auto__["fromCharCode"]).call(o__11873__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14452 = num_code;
switch (G__14452) {
case (1):
return (185);
...
var o__11873__auto__ = String;
return (o__11873__auto__["fromCharCode"]).call(o__11873__auto__,superscript_code);
});
/**
...
}catch (e14522){var _e__11889__auto__ = e14522;
return false;
}})())){
...
var vec__14529 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14529,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var o14605 = temp__5802__auto__;
var temp__5802__auto____$1 = (o14605["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o14606 = temp__5802__auto____$1;
return (o14606["nameToPath"]);
} else {
return null;
}
} else {
...
var len__5726__auto___15247 = arguments.length;
var i__5727__auto___15248 = (0);
while(true){
if((i__5727__auto___15248 < len__5726__auto___15247)){
args__5732__auto__.push((arguments[i__5727__auto___15248]));

var G__15249 = (i__5727__auto___15248 + (1));
i__5727__auto___15248 = G__15249;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14626){
var vec__14629 = p__14626;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14629,(0),null);
...
var G__15251 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__15252 = cljs.core.butlast(remaining_tokens);
name_tokens = G__15251;
remaining_tokens = G__15252;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14616){
var G__14618 = cljs.core.first(seq14616);
var seq14616__$1 = cljs.core.next(seq14616);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14618,seq14616__$1);
}));
...
var vec__14666 = cljs.core.split_with((function (p1__14664_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__14664_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14666,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14666,(1),null);
...
var vec__14689 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14689,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14689,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__15263 = cljs.core.rest(remaining_tokens);
var G__15264 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__15263;
name_tokens = G__15264;
continue;
} else {
...
var vec__14731 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14731,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14731,(1),null);
var vec__14734 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14734,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14734,(1),null);
var vec__14737 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14737,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14737,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14737,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14737,(3),null);
...
var vec__14764 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14764,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14764,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14764,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14764,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14764,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14764,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__14773 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14773,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14773,(1),null);
var vec__14778 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14778,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14778,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__14803 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__14803) : devtools.munging.parse_fn_info_deep.call(null,G__14803));
})()));
}
} else {
return fn_info;
...
var G__15323 = (arity + (1));
var G__15324 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14876){
var vec__14877 = p__14876;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14877,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14877,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14943_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__14943_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14944_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__14944_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14980){
var vec__14981 = p__14980;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14981,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14956){
var G__14957 = cljs.core.first(seq14956);
var seq14956__$1 = cljs.core.next(seq14956);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14957,seq14956__$1);
}));
...
var o__11873__auto__ = f;
return (o__11873__auto__["getBasis"]).call(o__11873__auto__);
});
/**
...
}catch (e15080){var _e__11889__auto__ = e15080;
...
var G__15372 = (obj[cljs.core.first(path)]);
var G__15373 = cljs.core.rest(path);
obj = G__15372;
path = G__15373;
continue;
} else {
...
var _STAR_ = (function (accum,p__15116){
var vec__15117 = p__15116;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15117,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15117,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15137){
var vec__15138 = p__15137;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15138,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15138,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15138,(2),null);
...
var post_process = (function (p__15167){
var vec__15168 = p__15167;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15168,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15168,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15158_SHARP_){
return (obj[cljs.core.first(p1__15158_SHARP_)]);
}),sorted_matches);
