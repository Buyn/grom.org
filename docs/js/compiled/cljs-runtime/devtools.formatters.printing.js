...
while(true){
if((i__5727__auto___15923 < len__5726__auto___15921)){
args__5732__auto__.push((arguments[i__5727__auto___15923]));

var G__15926 = (i__5727__auto___15923 + (1));
i__5727__auto___15923 = G__15926;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15695){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15769_SHARP_){
return (!((cljs.core.meta(p1__15769_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15823__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15826){var _e__11889__auto__ = e15826;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e15828){var _e__11889__auto__ = e15828;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__15840 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15841 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15841);

try{var map__15842 = opts;
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15840);
}});
...
var temp__5802__auto___16040 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___16040)){
var managed_print_level_16042 = temp__5802__auto___16040;
var _STAR_print_level_STAR__orig_val__15880_16044 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__15881_16045 = managed_print_level_16042;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__15881_16045);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__15849_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__15849_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__15880_16044);
}} else {
job_fn();
}
