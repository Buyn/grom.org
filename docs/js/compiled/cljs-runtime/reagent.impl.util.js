...
var vec__16893 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__16895;
var parts = seq__16894__$1;
...
var self__ = this;
var self__ = this;
var G__16947 = (arguments.length - (1));
switch (G__16947) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args16939){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args16939)));
}));
...
var _STAR_always_update_STAR__orig_val__17204 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__17205 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__17205);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__17204);
}} else {
