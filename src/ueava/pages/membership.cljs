  ...
  {:en
   ...
   :uk
    {:title "Членство в UEAVA"
     ...
     :b4-title "Перелік спеціалістів"
     :b4-subtitle "Включення до переліку практикуючих екзотологів України"
     :b4-text "Члени UEAVA можуть бути включені до загального переліку ветеринарних лікарів, які працюють з екзотичними тваринами, що допомагає власникам тварин знаходити профільних спеціалістів."
     :b5-title "Фахова спільнота"
     :b5-subtitle "Фахова спільнота та підтримка колег"
     ...
     :b6-text "Оформлюючи членство асоціації, ви долучаєтесь до розвитку професійної ветеринарної спільноти, популяризації доказової медицини та формування сучасних стандартів лікування екзотичних тварин."
